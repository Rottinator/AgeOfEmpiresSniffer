...
ActionHandler::ActionHandler(BinaryReaderBase* reader)
{
	_reader = reader;
}

void ActionHandler::ReadAndHandleAction()
{
	Action action;
...
void ActionHandler::ReadUnitInteraction(Action action)
{
...
void ActionHandler::ReadMovement(Action action)
{
...
void ActionHandler::ReadSetOutput(Action action)
{
...
void ActionHandler::ReadBuilding(Action action)
{
...
void ActionHandler::ReadRecruitment(Action action)
{
	int buildingId = _reader->ReadInteger();
...
void ActionHandler::ReadResearch(Action action)
{
	int buildingId = _reader->ReadInteger();
...
void ActionHandler::ReadAndPrintIntegers(int count)
{
